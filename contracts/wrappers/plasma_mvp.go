...
//
// Solidity: function deployedBlock() constant returns(uint256)
func (_PlasmaMVP *PlasmaMVPCaller) DeployedBlock(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _PlasmaMVP.contract.Call(opts, out, "deployedBlock")
	return *ret0, err
}
...
//
// Solidity: function deployedBlock() constant returns(uint256)
func (_PlasmaMVP *PlasmaMVPSession) DeployedBlock() (*big.Int, error) {
	return _PlasmaMVP.Contract.DeployedBlock(&_PlasmaMVP.CallOpts)
}

// DeployedBlock is a free data retrieval call binding the contract method 0x82ea7bfe.
//
// Solidity: function deployedBlock() constant returns(uint256)
func (_PlasmaMVP *PlasmaMVPCallerSession) DeployedBlock() (*big.Int, error) {
	return _PlasmaMVP.Contract.DeployedBlock(&_PlasmaMVP.CallOpts)
}
...
//
// Solidity: function depositExits( uint256) constant returns(amount uint256, committedFee uint256, createdAt uint256, ethBlockNum uint256, owner address, state uint8)
...
//
// Solidity: function plasmaChain( uint256) constant returns(header bytes32, numTxns uint256, feeAmount uint256, createdAt uint256, ethBlockNum uint256)
...
//
// Solidity: function txExits( uint256) constant returns(amount uint256, committedFee uint256, createdAt uint256, ethBlockNum uint256, owner address, state uint8)
