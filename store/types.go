...
func NewTxOutput(output plasma.Output, pos plasma.Position, spent bool, spenderTx []byte, inputAddresses []ethcmn.Address, inputPositions []plasma.Position) TransactionOutput {
