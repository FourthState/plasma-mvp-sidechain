...
func NewSpendMsg(blknum1 uint, txindex1 uint, oindex1 uint, amount1 uint, confirmSigs1 [2]crypto.Signature,
	blknum2 uint, txindex2 uint, oindex2 uint, amount2 uint, confirmSigs2 [2]crypto.Signature,
