...
# > docker run -it -p 26657:26657 -p 26656:26656 -v ~/.plasmad:/root/.plasmad -v ~/.gaiacli:/root/.gaiacli plasmad plasmad init
# > docker run -it -p 26657:26657 -p 26656:26656 -v ~/.plasmad:/root/.plasmad -v ~/.gaiacli:/root/.gaiacli plasmad plasmad start
...
# Copy over server binary from the build-env
